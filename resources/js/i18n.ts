...
export const resources = {
  en: {
    translation: {
      ...
      "footer.repository": "Project repository",
      "footer.support": "Support on GitHub",
      "footer.version": "Version {{version}}",
      "footer.check": "Check for updates",
      "footer.checking": "Checking…",
      "footer.updating": "Updating…",
      "footer.update_available": "Update to {{version}}",
      "footer.check_failed": "Update check failed",
      "footer.confirm_title": "Install update?",
      "footer.confirm_body":
        "IpamFerry will update from {{current}} to {{next}} and briefly restart.",
      "footer.confirm_warning":
        "Do not close the browser while the update starts. Active migrations must finish first.",
      "footer.cancel": "Cancel",
      "footer.confirm": "Install update",
  ...
  pt_BR: {
    translation: {
      ...
      "footer.created_by": "Criado por",
      "footer.repository": "Repositório do projeto",
      "footer.support": "Apoiar no GitHub",
      "footer.version": "Versão {{version}}",
      "footer.check": "Verificar atualizações",
      "footer.checking": "Verificando…",
      "footer.updating": "Atualizando…",
      "footer.update_available": "Atualizar para {{version}}",
      "footer.check_failed": "Falha ao verificar atualização",
      "footer.confirm_title": "Instalar atualização?",
      "footer.confirm_body":
        "O IpamFerry será atualizado de {{current}} para {{next}} e reiniciará brevemente.",
      "footer.confirm_warning":
        "Não feche o navegador enquanto a atualização inicia. Migrações ativas devem terminar primeiro.",
      "footer.cancel": "Cancelar",
      "footer.confirm": "Instalar atualização",
  ...
  es: {
    translation: {
      ...
      "footer.repository": "Repositorio del proyecto",
      "footer.support": "Apoyar en GitHub",
      "footer.version": "Versión {{version}}",
      "footer.check": "Buscar actualizaciones",
      "footer.checking": "Comprobando…",
      "footer.updating": "Actualizando…",
      "footer.update_available": "Actualizar a {{version}}",
      "footer.check_failed": "Falló la búsqueda de actualización",
      "footer.confirm_title": "¿Instalar actualización?",
      "footer.confirm_body":
        "IpamFerry se actualizará de {{current}} a {{next}} y se reiniciará brevemente.",
      "footer.confirm_warning":
        "No cierre el navegador mientras inicia la actualización. Las migraciones activas deben finalizar primero.",
      "footer.cancel": "Cancelar",
      "footer.confirm": "Instalar actualización",
